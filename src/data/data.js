...
// きょうの めあて (クエストの案内がない日も、その日らしい「やること」を そっと しめす)
// — 「なにも やることがない日」を なくすための、31日ぶんの 道しるべ
export const DAY_GUIDE = {
  1: 'まちを あるいてみよう。かどの みちを いくと 川に でる',
  2: 'あさ6時すぎ、じんじゃの ひろばで ラジオたいそう (スタンプ)',
  3: 'くもりの日は 虫とりびより。木を Eで しらべてみよう',
  4: 'ため池の げんじいに あいさつ。つりざおを かしてくれるかも',
  5: '雨の日の 川では ウグイが つれるらしい',
  6: 'ホタルは こよいまで。よる、かわべに いってみよう',
  7: 'ゆうびんうけに なにか とどいとるかも',
  8: 'だがしやで ラムネ。王冠あつめと ガチャも わすれずに',
  ...
  23: 'たきつぼの アユ、きょうは なんびき つかまえられる?',
  24: 'あすは まつり! じんじゃの じゅんびを のぞいてみよう',
  25: 'よるは 滝宮の なつまつり! じんじゃへ くりだそう',
  26: 'まつりの あとの じんじゃで、おみくじを ひいてみよう',
  27: 'ずかんの あなうめ。まだ見ぬ 虫や さかなを さがそう',
  28: 'ケンタや ミナと あそべる日は のこりわずか。こえを かけよう',
  29: 'こころのこりは ないか、すきな ばしょを まわっておこう',
  30: 'さいごの まえの日。ゆうがたの まちを ゆっくり あるこう',
  31: 'きょうが さいごの日。みんなに おわかれを いいにいこう',
};
